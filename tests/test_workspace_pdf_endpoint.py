...
_REAL_PDFS = [
    Path(r"D:/All projects/ArcheAxis-Knowledge-OS/.project-local/desktop-attachments/时间简史（插图本）.pdf"),
    Path(r"D:/All projects/ArcheAxis-Knowledge-OS/.project-local/desktop-attachments/牛津通识读本：缤纷的语言学（中文版）.pdf"),
]
