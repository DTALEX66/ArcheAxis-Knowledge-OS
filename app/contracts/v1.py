...
TASKPACK_SCHEMA_ID = "https://archeaxis.local/contracts/v1/taskpack.schema.json"
EXECUTION_TRACE_SCHEMA_ID = (
    "https://archeaxis.local/contracts/v1/execution-trace.schema.json"
)
EVALUATION_SCHEMA_ID = "https://archeaxis.local/contracts/v1/evaluation.schema.json"
LESSON_SCHEMA_ID = "https://archeaxis.local/contracts/v1/lesson.schema.json"
...
EVIDENCE_SCHEMA_ID = "https://archeaxis.local/contracts/v1/evidence.schema.json"
...
MASTERY_SIGNAL_SCHEMA_ID = (
    "https://archeaxis.local/contracts/v1/mastery-signal.schema.json"
)
