...
│   └── contracts.py (TaskPackV1/ExecutionTraceV1/EvaluationV1/LessonV1/SourceRecordV1 + verified adapters; other objects remain identity exports)
├── Core Runtime
│   ├── ingest / route / run
