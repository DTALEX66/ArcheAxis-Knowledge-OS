...
1. `SourceRecordV1` 与 `ClaimV1` tracer 已完成；外部来源和 caller-supplied claim 保持 candidate/人工复核，不允许治理状态静默升级或降级。
2. 下一步依次建立 `EvidenceV1`、`ResearchPackageV1`，明确来源独立性、冲突、未知与风险边界。
