...
| 当前执行与架构决策 | `PROJECT_CONTRACT.yaml`、`DECISION_SUPERSESSION_LEDGER.yaml`、`docs/authority/taskpack-0907/EXECUTION.md` | 已批准的 AAK-REUSE-FIRST-20260907-R2 路线与实时台账；GPT 审计板 `docs/authority/taskpack-0907/Q00-Q01-AUDIT-2026-09-07.md`；0906 仅历史（SUP-012..016），收据保留原 SHA |
