...
| `v0.6.1` | yes | no | — | — | Historical unpublished tag at `f75021c`; Release run `32586776986` failed because the public identity was injected after the CI candidate installer had been built. Preserved; remediation proceeds as `v0.6.2`. |
...
- Source manifest line is `0.6.2`, `unreleased`, `development`, `public=false`;
