...
| `v0.6.0` | yes | no | — | — | Historical unpublished tag at `0b633a6`; preserved by the immutable-tag policy. Remediation release proceeds as `v0.6.1`. |
...
- Source manifest line is `0.6.1`, `unreleased`, `development`, `public=false`;
