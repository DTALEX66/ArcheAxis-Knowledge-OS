# v0.6.7 System Boundary (v0.6.0 task scope)

ArcheAxis Knowledge is a local-first trusted-knowledge workspace. The v0.6.7
...
reference surfaces, never v0.6.7 release authority.
