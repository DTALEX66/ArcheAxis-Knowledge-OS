# v0.6.5 System Boundary (v0.6.0 task scope)

ArcheAxis Knowledge is a local-first trusted-knowledge workspace. The v0.6.5
...
reference surfaces, never v0.6.5 release authority.
...
current release state is `v0.6.5 development — PARTIAL` until exact-SHA tests,
