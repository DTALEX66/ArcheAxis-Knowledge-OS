# v0.6.0 System Boundary

ArcheAxis Knowledge is a local-first trusted-knowledge workspace. Its v0.6.0
release boundary is the following closed loop:
...
reference surfaces, never v0.6.0 release authority.
...
current release state is `v0.6.0 development — PARTIAL` until exact-SHA tests,
