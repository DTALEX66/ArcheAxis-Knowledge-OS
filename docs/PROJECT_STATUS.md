...
- 当前源码版本为 `0.6.12`；packaged source manifest 按合同仍是 `unreleased / public=false`。公开 v0.6.11 artifact identity 为 `stable / public=true` 且保持不可变；v0.6.12 的发布工程与 UI 产品验收证据见下方记录与 `README.md`。
