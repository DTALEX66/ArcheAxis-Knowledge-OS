...
- Phase 2 已建立 `TaskPackV1` 与 `ExecutionTraceV1`：TaskPack 支持 KB dataclass/SQLite row 无损往返、Runtime 窄投影和可回滚迁移；Execution Trace 支持 Runtime/SQLite row 无损往返并对未知行字段 fail closed。
