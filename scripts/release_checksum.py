...
Usage:
    python scripts/release_checksum.py --wheel .project-local/build/release-assets/*.whl --installer .project-local/build/release-assets/*.exe --output .project-local/task-runtime/artifacts/release-checksums.txt
