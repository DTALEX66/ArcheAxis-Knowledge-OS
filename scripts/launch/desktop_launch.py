...
def prepare_launch(*, desktop: Path | None = None, core: Path | None = None,
    ...
    receipt = {
        ...
        'environment': {'ARCHEAXIS_PYTHON': str(python),
                        'ARCHEAXIS_SCHEDULER_WORKER': str(REPO / 'services/python-workers/learning/worker_schedule.py'),
                        'ARCHAXIS_SCHEDULER_WORKER': str(REPO / 'services/python-workers/learning/worker_schedule.py'),
