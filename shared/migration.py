...
WORKSPACE_DELIVERY_RECEIPT_MIGRATION_VERSION = 14
WORKSPACE_DELIVERY_RECEIPT_MIGRATION_NAME = "phase5_workspace_delivery_receipts_v2"
SLEEP_LOOP_MIGRATIONS = {
    12: "phase8_sleep_loop_runtime_leases_v1",
    13: "phase8_sleep_loop_review_gate_v2",
}
SLEEP_LOOP_MIGRATION_VERSION = max(SLEEP_LOOP_MIGRATIONS)
SLEEP_LOOP_MIGRATION_NAME = SLEEP_LOOP_MIGRATIONS[SLEEP_LOOP_MIGRATION_VERSION]
ROLLBACK_MIGRATION_NAMES = set(TASKPACK_MIGRATIONS.values()) | {
    ...
    WORKSPACE_DELIVERY_RECEIPT_MIGRATION_NAME,
    BASELINE_MIGRATION_NAME,
} | set(SLEEP_LOOP_MIGRATIONS.values())
TASKPACK_COLUMNS = {
    "id",
    "context_id",
    "goal",
